...
--
-- Banco de dados: `alicejoin`
--
DROP DATABASE IF EXISTS `alicejoin`;
CREATE DATABASE IF NOT EXISTS `alicejoin` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `alicejoin`;
